...
<h2 class="flex justify-center pb-6 text-2xl">Bienvenue sur mon Portfolio</h2>
<div class="flex justify-center">
	<div class="rounded-4xl bg-cover bg-center" style="background-image: url({bg2});">
		<div
			class="card rounded-4xl border-primary bg-cover bg-center shadow-xl backdrop-blur-lg transition duration-500 card-border hover:backdrop-filter-none"
		>
			<div class="card-body flex flex-row gap-9 p-10">
				<div class="hover-3d">
					<div class="avatar">
						<div class="w-64 rounded-4xl">
				...
				<div>
					<h1 class="pb-10 font-[ClashGrotesk-Medium] text-5xl">Elfin Pouget - - Pejoan</h1>
					<div class="flex pb-4">
						<svg
							viewBox="0 0 24 24"
							fill="none"
						...
						<p class="text-xl">Etudiant en Informatique à l'IUT Paul Sabatier à Toulouse</p>
					</div>
					<div class="flex pb-4">
						<svg
							viewBox="0 0 24 24"
						...
						<p class="text-xl">Alternant chez Oktal/Sogeclair</p>
					</div>
					<div class="flex">
						<svg
							viewBox="0 0 24 24"
